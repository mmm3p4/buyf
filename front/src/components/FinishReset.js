...
const FinishReset = (props) => {
    ...
    const handleFormSubmit = async (event,newPassword, newPasswordRepeat ) => {
    ...
    return (
        ...
        <Label for="newPassword" style={{ fontSize: "20px", color: "#9A1656", fontWeight: "bold" }}>Новый пароль</Label>
        <Input
            type="password"
            name="newPassword"
            id="newPassword"
    ...
    <FormGroup>
        <Label for="newPasswordRepeat"  style={{ fontSize: "20px", color: "#9A1656", fontWeight: "bold" }}>Повторите пароль</Label>
        <Input
            type="password"
    ...
    <Button variant="btn-light" onClick={handleFormSubmit} style={{ backgroundColor: "#F0DAE1", color: "#9A1656", display: "block", margin: "0 auto", marginBottom: "2%", border: "none" }}>Восстановить пароль</Button>
    </>
    )}
